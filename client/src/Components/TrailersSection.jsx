    ...
    return (
        <div className='px-6 md:px-16 1g:px-24 x1:px-44 py-20 overflow-hidden'>
            ...
            <div className='relative mt-6'>
                ...
                <ReactPlayer src={currentTrailer?.video} controls={false}
            ...
            <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3x1 mx-auto'>
                ...
                group-hover:not-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:max-h-60 cursor-pointer' onClick={() =>
                            setCurrentTrailer(trailer)}>
                        <img src={trailer.image} alt="trailer" className='rounded-1g w-full h-full object-cover brightness-75' />
